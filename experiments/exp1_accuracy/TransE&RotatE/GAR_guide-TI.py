...
# 1. 读取文件
predictions_df = pd.read_csv('/mnt/f/graduate/GARplus/exp1_accuracy/exp1_accuracy/TransE&RotatE/predictions/TI_rotate_20pct/predictions_with_original_ids.csv')
negative_rules_df = pd.read_csv('/mnt/f/graduate/GARplus/exp1_accuracy/exp1_accuracy/TransE&RotatE/negative_pairs/ti_rule_negative_pairs_0626.csv')

# 2. 构建需要修正的边集合
negative_pairs_to_fix = set(zip(negative_rules_df['gene_index'], 
...
# 5. 保存修改日志
pd.DataFrame(modification_log).to_csv('/mnt/f/graduate/GARplus/exp1_accuracy/exp1_accuracy/TransE&RotatE/modified_prediction/TI_rotate_20pct.csv', index=False)
