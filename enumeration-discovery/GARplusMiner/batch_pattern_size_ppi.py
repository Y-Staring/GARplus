...
DEFAULT_RESULT_ROOT = (
    Path("/mnt/d/CodeWork/python/GAR+/GARplus/enumeration-discovery/online_result/pattern_size_recall")
    if Path("/mnt/d").exists()
    else Path(r"D:\CodeWork\python\GAR+\GARplus\enumeration-discovery\online_result\pattern_size_recall")
)
RESULT_DIR = Path(os.environ.get("GARPLUS_PATTERN_SIZE_RESULT_DIR", DEFAULT_RESULT_ROOT / "pattern_size_ppi"))
